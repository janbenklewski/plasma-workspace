...
class NOTIFICATIONMANAGER_EXPORT Settings : public QObject
{
     ...
     */
    Q_PROPERTY(QDateTime notificationsInhibitedUntil READ notificationsInhibitedUntil WRITE setNotificationsInhibitedUntil RESET resetNotificationsInhibitedUntil NOTIFY settingsChanged)
     ...
     * @since 5.17
     */
    Q_PROPERTY(bool inhibitNotificationsWhenScreensMirrored READ inhibitNotificationsWhenScreensMirrored WRITE setInhibitNotificationsWhenScreensMirrored NOTIFY settingsChanged)
